...
conn.execute("INSERT INTO 'props' (id,property_title,price,bathrooms,bedrooms,suburbs,pets_allowed,garage,furnished,available) VALUES (1,'123 sesame st',500,1,4,'Muppet city','yes','no','no','yes')")
conn.commit()