...
conn.execute("INSERT INTO 'props' (property_title,price,bathrooms,bedrooms,suburbs,pets_allowed,garage,furnished,available) VALUES ('123 sesame st',150,1,50,'Muppet city','yes','no','no','yes')")
conn.execute("INSERT INTO 'props' (property_title,price,bathrooms,bedrooms,suburbs,pets_allowed,garage,furnished,available) VALUES ('456 Calluza Pl',500,4,9,'Waiheke','no','yes','yes','no')")
conn.commit()